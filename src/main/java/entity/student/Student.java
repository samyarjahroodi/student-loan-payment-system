...
public class Student extends Person {
    ...
    public Student(String firstname, String lastname, String fatherName, String motherName, String idOfBirthCertificate,
                   String nationalCode, Date dateOfBirth, String studentCode, Integer entranceYear, Grade grade,
                   String password, boolean isMarried, boolean accommodateInUniversity, String nameOfUniversity,
